...
export default ARGeometry(
  ...
  props => {
    ...
    if (!props.extrusion) temp = 1;
    // Basically a plane
    else if (!props.chamferRadius) temp = 3;
    // There is extrusion but no chamfer - like an extruded disc
    else if (props.chamferMode == 0) temp = 5; // THere is extrusion and double-chamfer - extruded disc with bezeling front and back
    return temp;
  },
  {
    extrusion: 1.0,
